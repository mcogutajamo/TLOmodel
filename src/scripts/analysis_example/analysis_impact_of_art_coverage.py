...
if __name__ == "__main__":
    ...
    print(log_run0)
    print(log_run0['tlo.methods.hiv_lite']['aids_cases'])
    print(log_run1['tlo.methods.hiv_lite']['aids_cases'])
    # Extract the results to excel files
    log_run0['tlo.methods.hiv_lite']['aids_cases'].to_excel('./outputs/aids_cases_run0.xlsx')
    log_run1['tlo.methods.hiv_lite']['aids_cases'].to_excel('./outputs/aids_cases_run1.xlsx')
